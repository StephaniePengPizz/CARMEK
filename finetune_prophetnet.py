...
def finetune_prophetnet(data_name):
    if data_name == "bioasq":
        datasets = build_dataset_for_bio()
    else:
        datasets = build_dataset_for_pubmedqa()
    model_name = "/root/autodl-tmp/prophetnet-large-squad"
    ...
    training_args = Seq2SeqTrainingArguments(
        f"/root/autodl-tmp/my_qa_model3",
    ...
    trainer.save_model("/root/autodl-tmp/my_prophetnet_model_on_{}".format(data_name))

def use_prophetnet(data_name):
    ...
    #]
    tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/my_prophetnet_model_on_{}".format(data_name))
    model = AutoModelForSeq2SeqLM.from_pretrained("/root/autodl-tmp/my_prophetnet_model_on_{}".format(data_name))
...
finetune_prophetnet("pubmedqa")
use_prophetnet("pubmedqa")
#finetune_prophetnet("bioasq")
#use_prophetnet("bioasq")
