...
def finetune_bart(data_name):
    ...
    model_name = "/root/autodl-tmp/bart-base-squad"
    ...
    trainer.save_model("/root/autodl-tmp/my_bart_model_on_{}".format(data_name))

def use_bart(data_name):
    ...
    #]
    tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/my_bart_model_on_{}".format(data_name))
    model = AutoModelForSeq2SeqLM.from_pretrained("/root/autodl-tmp/my_bart_model_on_{}".format(data_name))
    #tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/my_qa_model/checkpoint-6750".format(data_name))
    #model = AutoModelForSeq2SeqLM.from_pretrained("/root/autodl-tmp/my_qa_model/checkpoint-6750".format(data_name))
...
print(1)
#finetune_bart("pubmedqa")
use_bart("pubmedqa")
#finetune_bart("bioasq")
#use_bart("bioasq")
